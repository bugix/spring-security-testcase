 ...
 * @author Keesun Baik
 */
public abstract class AbstractSecurityWebApplicationInitializerFixed implements WebApplicationInitializer {
     ...
     */
    protected AbstractSecurityWebApplicationInitializerFixed() {
     ...
     */
    protected AbstractSecurityWebApplicationInitializerFixed(Class<?>... configurationClasses) {
